...
EV_CAR = {CAR.VOLT, CAR.VOLT_NR, CAR.BOLT_EV, CAR.BOLT_EUV, CAR.BOLT_EV_CC}

# We're integrated at the camera with VOACC on these cars (instead of ASCM w/ OBD-II harness)
CAMERA_ACC_CAR = {CAR.BOLT_EV, CAR.VOLT_NR, CAR.BOLT_EUV, CAR.SILVERADO, CAR.EQUINOX, CAR.BOLT_EV_CC}

CC_ONLY_CAR = {CAR.BOLT_EV_CC, CAR.VOLT_NR}
